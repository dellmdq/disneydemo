DROP DATABASE  IF EXISTS `spring_security_user_login`;

CREATE DATABASE  IF NOT EXISTS `spring_security_user_login`;
USE `spring_security_user_login`;
...
CREATE TABLE `user` (
  ...
  `password` char(80) NOT NULL,users_roles
